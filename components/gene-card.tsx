...
export function GeneCard({ geneInfo, annotation }: any) {
  return (
    <Card className="flex flex-col w-96 p-4 gap-3">
      ...
      <Card className="bg-secondary items-center justify-center h-full">
        ...
        <CardContent className="flex flex-col gap-2 gap-5">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-row text-sm gap-4 border">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col text-sm gap-2 border overflow-scroll h-38">
